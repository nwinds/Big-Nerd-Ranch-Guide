...
@interface HomeContainerViewController () <UIScrollViewDelegate>

@property (weak, nonatomic) IBOutlet UIScrollView *scrollView;
@property (weak, nonatomic) IBOutlet UIView *menuContainerView;

@property (nonatomic, weak) HomeMenuViewController *menuViewController;
@property (nonatomic, weak) HomeDetailViewController *detailViewController;
