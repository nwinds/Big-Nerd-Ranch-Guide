...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.viewController = [[[([UIApplication sharedApplication].delegate).window rootViewController] storyboard] instantiateViewControllerWithIdentifier:@"indexController"];
...
//    [self.viewController checkIsUserSignedIn];
    ...
    NSLog(@"Will back to frontground!");
}
